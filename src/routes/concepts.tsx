...
export const Route = createFileRoute("/concepts")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Core concepts for planning optimization with Timefold." },
...
function ConceptsPage() {
  return (
    <div className="p-6">
      ...
      <p className="mt-2 text-muted-foreground">Learn the building blocks of constraint-based planning.</p>

      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        {["Planning entities", "Planning variables", "Constraints", "Score calculation", "Solver phases"].map(
          (concept) => (
